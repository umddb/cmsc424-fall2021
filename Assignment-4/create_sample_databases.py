...
def createDatabase1(name):
    ...
    r1_schema = ["A", "B", "C"]
    r2_schema = ["B"]
    r1 = db.newRelation("r1", r1_schema)
    r2 = db.newRelation("r2", r2_schema)
    r1.insertTuple(Tuple(r1_schema, ('a1', 'b1', 'c1')));
    r1.insertTuple(Tuple(r1_schema, ('a1', 'b2', 'c1')));
    r1.insertTuple(Tuple(r1_schema, ('a1', 'b3', 'c1')));
    r1.insertTuple(Tuple(r1_schema, ('a2', 'b1', 'c2')));
